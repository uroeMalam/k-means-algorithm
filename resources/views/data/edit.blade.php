            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <select class="form-control" id="tahun" name="tahun" >
                        ...
                        <option value="2019" {{($tahun) ? "selected" :""}}>2019</option>
                        <option value="2020" {{($tahun) ? "selected" :""}}>2020</option>
                        <option value="2021" {{($tahun) ? "selected" :""}}>2021</option>
                        <option value="2022" {{($tahun) ? "selected" :""}}>2022</option>
                    </select>
