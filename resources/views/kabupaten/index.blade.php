...
<div class="container-fluid mt--6">
    ...
    <div class="col">
        ...
        <div class="card-header">
            <div class="row">
            <div class="col">
            <h2 class="mb-0">Kabupaten/Kota</h2>
            </div>
            <div class="col-auto">
...
@push('page-scripts')
    ...
    $(document).ready(function () {
        ...
        var table = $('.data-table').DataTable({                
            ...
            serverSide: true,
            rowId:"id",
            ajax: "{{ route('kabupaten_dataTable') }}",
            columns: [
    ...
    $(document).on('click', '#edit',function (e) {
      ...
      $(document).on('click', '#hapusData', function(e) {
        e.preventDefault();
        var url = "{{ route('kabupaten_destroy') }}";
        var csrf= '{{ csrf_token() }}';
