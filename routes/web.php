...
Route::get('/data/data-table', [DataController::class, 'DataTable'])->name('data_dataTable');

// Hasil Perhitungan
Route::get('/perhitungan', [PerhitunganController::class, 'index'])->name('perhitungan');
Route::get('/perhitungan/data-table', [PerhitunganController::class, 'DataTable'])->name('perhitungan_dataTable');
